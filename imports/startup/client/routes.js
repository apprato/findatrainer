...
import Products from "../../ui/containers/ProductsList.js";
import ViewProduct from "../../ui/containers/ViewProduct";
    ...
    <Router history={browserHistory}>
      <Route path="/" component={App}>
        ...
        <Route
          ...
          path="/clients/page/:_id"
          component={Clients}
          onEnter={authenticate}
        />
        <Route
          name="NewClientMeasurement"
          path="/client/new/measurement"
          component={NewClientMeasurement}
          onEnter={authenticate}
        />
        <Route
          name="EditClientMeasurement"
          path="/client/edit/measurement"
          component={EditClientMeasurement}
          onEnter={authenticate}
        />
        <Route
        ...
        />
        <Route
          name="MyAccountEditTrainerExperience"
          path="/myaccount/trainer/edit/experience"
          component={MyAccountEditTrainerExperience}
          onEnter={authenticate}
        />
        <Route
          name="MyAccountEditTrainerProfile"
          path="/myaccount/trainer/edit/profile"
          component={MyAccountEditTrainerProfile}
          onEnter={authenticate}
        />
        <Route
          name="jobs"
        ...
        <Route
          name="jobs"
          path="/jobs/search/:_search"
          component={Jobs}
          onEnter={authenticate}
        />
        <Route
          name="jobs"
          path="/jobs/search/:_search/page/:_id"
          component={Jobs}
          onEnter={authenticate}
        />
        <Route
          name="jobs"
          path="/jobs/search/:_search/category/:_category"
          component={Jobs}
          onEnter={authenticate}
        />
        <Route
          name="jobs"
          path="/jobs/search/:_search/category/:_category/page/:id"
          component={Jobs}
          onEnter={authenticate}
        />
        <Route
          name="jobs"
          path="/jobs/category/:_category"
          component={Jobs}
          onEnter={authenticate}
        />
        <Route
          name="jobs"
          path="/jobs/category/:_category/page/:_id"
          component={Jobs}
          onEnter={authenticate}
        />
        <Route
          name="jobs"
          path="/jobs/category/:_category/state/:_state"
          component={Jobs}
          onEnter={authenticate}
        />
        <Route
          name="viewJobsPagination"
          path="/jobs/page/:_id"
          component={Jobs}
          onEnter={authenticate}
        />
        ...
        <Route
          ...
          path="/trainer/new/product"
          component={NewTrainerProduct}
          onEnter={authenticate}
        />
        <Route
          name="marketplace"
        ...
        <Route path="chat-room" component={PublicChatRoomsListContainer} />
        <Route
